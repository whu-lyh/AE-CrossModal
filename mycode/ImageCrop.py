...
'''
Usage:
    python ImageCrop.py --raw_path /workspace/kitti360 --target_pano_path /workspace/kitti360 --single_image
    python ImageCrop.py --raw_path /workspace/kitti360 --target_pano_path /workspace/kitti360 --single_sequence
    python ImageCrop.py --raw_path /workspace/kitti360 --target_pano_path /workspace/kitti360
'''
