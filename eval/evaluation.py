...
if trained:
    model_path2d = "/root/lyh/code/AE-CrossModal/weights/checkpoint_epoch49.pth.tar"  # Aug21_22-09-09_vgg_clu64_2
    model_path3d = "/root/lyh/code/AE-CrossModal/weights/checkpoint_epoch49.ckpt" # Aug27_16-38-16_vgg_f2_resume_h
...
recalls = val(validation_dataset, model2d, model3d, device, 6, config, writer, size, 0, write_tboard=False, pbar_position=1)
